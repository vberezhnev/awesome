...
-- Change icon of notification size
naughty.config.defaults['icon_size'] = 120

-- {{{ Variable definitions
-- Themes define colours, icons, font and wallpapers.
beautiful.init("/home/beethoven/.config/awesome/theme.lua")
...
{ 
   ...
   "xrandr --output eDP-1 --right-of HDMI-1 --primary",
   "xset s &",
}
if autorun then
...
awful.screen.connect_for_each_screen(function(s)
	...
	{ -- Right widgets
            layout = wibox.layout.fixed.horizontal,
	    weather_widget({
	            api_key='abdb3b3809b741ec5db31a92439b6aaf',
		    coordinates = {43.1545, 131.9279},
	    }),
	    volume_widget{
		device = "pipewire",
	        widget_type = 'arc',
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width, --
                     border_color = "#fff", -- beautiful.border_normal
    ...
    -- Set always map on the tag named "X" on screen Y.
    --{ rule = { name = "Discord" },
